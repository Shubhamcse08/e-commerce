  ...
  return productData ?(
    <div className="border-gray-300 border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex-1 flex flex-col-reverse gap-3 sm:flex-row">
        <div className="flex sm:flex-col overflow-x-auto sm:overscroll-y-auto justify-between sm:justify-normal sm:w-[18.7%] w-full ">
      ...
      {/* description and review section________-- */}
      <div className="mt-20">
        <div className="flex">
            <b className="border px-5 py-3 text-sm">Description</b>
            <p className="border px-5 py-3 text-sm">Reviews (122)</p>
        </div>
        <div className="flex flex-col gap-4 px-6 py-6 text-sm border text-gray-500">
